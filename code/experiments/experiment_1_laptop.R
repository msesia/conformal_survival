...
run_all_experiments <- function(setting, surv_model_type, cens_model_type, num_samples_train, num_samples_cal, num_samples_test, batch, alpha, batch_size=10, setup=1) {
